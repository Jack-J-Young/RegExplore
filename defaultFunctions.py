...
def categorysFromChars(chars, path):
    validCategories = []
...
def setCategoryPattern(properties):
    ...
    return categorysFromChars(charSet, copy.deepcopy(properties['currentNode']['path']))
    # validCategories = []
    # for category in CategoryType:
    #     if category != CategoryType.UNKOWN:
    #         categorySet = categoryToSet(category)
...
def minWrapPattern(properties):
    ...
    output = [minWrapCharSet(charSet, copy.deepcopy(properties['currentNode']['path']))]
...
def inchWrapPattern(properties):
    ...
    for indexSet in indexedSet:
        ...
        output.append(minWrapCharSet(cumulativeSet, path))
